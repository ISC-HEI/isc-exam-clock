...
const translations: Record<string, Record<Lang, string>> = {
  ...
  timerMode: { en: 'Timer mode (replaces clock)', fr: "Mode minuteur (remplace l'horloge)" },
  replayGong: { en: 'Replay gong', fr: 'Rejouer le gong' },
  relaunch: { en: 'Restart timer', fr: 'Relancer le minuteur' },
  backToClock: { en: 'Show clock', fr: "Afficher l'horloge" },
